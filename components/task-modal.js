                ...
                <div class="bg-card zen-card shadow-soft w-full max-w-2xl p-8 md:p-10 transform transition-all scale-95 opacity-0 relative mx-3 sm:mx-auto" id="task-modal-content">
                    ...
                    <form id="task-form" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="title" required placeholder="What needs to be done?" class="w-full zen-input bg-highlight border border-subtle focus:ring-2 focus:ring-primary/20 font-bold text-main text-sm outline-none transition-all" value="${escapeHTML(task?.title || '')}">
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="space-y-2">
                                ...
                                <select name="status" class="w-full zen-input bg-highlight border border-subtle text-main font-bold cursor-pointer appearance-none text-[11px] outline-none">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="priority" class="w-full zen-input bg-highlight border border-subtle text-main font-bold cursor-pointer appearance-none text-[11px] outline-none">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="task_type" id="modal-task-type" class="w-full zen-input bg-highlight border border-subtle text-main font-bold cursor-pointer appearance-none text-[11px] outline-none">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="notes" rows="3" placeholder="Add details, links, or anything helpful..." class="w-full py-3 px-4 bg-highlight border border-subtle rounded-xl focus:ring-2 focus:ring-primary/20 text-main text-sm outline-none transition-all resize-none font-medium text-main">${escapeHTML(task?.notes || '')}</textarea>
                        </div>
                        ...
                        <div class="space-y-4 border-t border-subtle pt-5">
                            ...
                            <div id="date-fields" class="${(task?.status && task.status !== 'backlog') || !task ? 'grid' : 'hidden'} grid-cols-2 gap-4 transition-all">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex gap-2">
                                        <div class="flex-1 flex gap-1 items-center">
                                            <input type="date" name="start_date" class="flex-1 zen-input bg-highlight border border-subtle text-[11px] font-bold text-main outline-none transition-all px-3">
                                        ...
                                        <div class="flex gap-1 items-center">
                                            <input type="time" name="start_time" class="w-24 zen-input bg-highlight border border-subtle text-[11px] font-bold text-main outline-none transition-all px-3">
                                            <div class="flex flex-col gap-0.5">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex gap-2">
                                        <div class="flex-1 flex gap-1 items-center">
                                            <input type="date" name="end_date" class="flex-1 zen-input bg-highlight border border-subtle text-[11px] font-bold text-main outline-none transition-all px-3">
                                            <div class="flex flex-col gap-0.5">
                                                <button type="button" class="date-shift-btn px-1.5 py-0.5 bg-white/5 hover:bg-primary/10 border border-white/5 hover:border-primary/20 rounded text-dim hover:text-primary transition-all" data-direction="1" title="+1 day">
                                                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 15l7-7 7 7"></path></svg>
                                                </button>
                                        ...
                                        <div class="flex gap-1 items-center">
                                            <input type="time" name="end_time" class="w-24 zen-input bg-highlight border border-subtle text-[11px] font-bold text-main outline-none transition-all px-3">
                                            <div class="flex flex-col gap-0.5">
                                                <button type="button" class="time-shift-btn px-1.5 py-0.5 bg-white/5 hover:bg-primary/10 border border-white/5 hover:border-primary/20 rounded text-dim hover:text-primary transition-all" data-direction="1" title="+15 min">
                                                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 15l7-7 7 7"></path></svg>
                                                </button>
                        ...
                        <div class="pt-4 grid grid-cols-4 gap-3">
                            ${task ? `
                                ...
                                <button type="submit" id="commit-task-btn" class="col-span-3 zen-btn bg-primary hover:bg-primary-dark text-white font-black text-[10px] uppercase tracking-[0.3em] shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5 active:scale-[0.98] leading-none">
                                    Update Task
                                </button>
                            ` : `
                                <button type="submit" id="commit-task-btn" class="col-span-4 zen-btn bg-primary hover:bg-primary-dark text-white font-black text-[10px] uppercase tracking-[0.3em] shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5 active:scale-[0.98] leading-none">
                                    Create Task
                                </button>
                            `}
                        </div>
