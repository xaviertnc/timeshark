...
- **Color Coding**: Mandatory. Colors act as visual anchors, seamlessly connecting timeline blocks and tasks to their origin project without requiring text labels on small interfaces.
...
> **Deletion is destructive.** Hard-deleting a project instantly severs its lineage. It permanently relabels associated time records as `[Deleted Project]` and wipes its active tasks. 
>
> [!TIP]  
